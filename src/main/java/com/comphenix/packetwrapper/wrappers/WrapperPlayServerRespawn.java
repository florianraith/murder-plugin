...
public class WrapperPlayServerRespawn extends AbstractPacket {
    ...
    public String toString() {
        return "WrapperPlayServerRespawn["
                + "dimensionType=" + this.getDimensionType()
                + ", dimension=" + this.getDimension()
                + ", seed=" + this.getSeed()
                + ", playerGameType=" + this.getPlayerGameType()
                + ", previousPlayerGameType=" + this.getPreviousPlayerGameType()
                + ", isDebug=" + this.getIsDebug()
                + ", isFlat=" + this.getIsFlat()
                + ", dataToKeep=" + this.getDataToKeep()
                + ", lastDeathLocation=" + this.getLastDeathLocation()
                + ", portalCooldown=" + this.getPortalCooldown()
                + "]";
    }
}